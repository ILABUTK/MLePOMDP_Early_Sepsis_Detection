...
class Vasopressors:
    ...
    def calc_SOFA(self, drugrate_norm, nursechartMAP):
        ...
        # change datatype
        df_cardiovascular['nursingchartvalue'] = pd.to_numeric(df_cardiovascular['nursingchartvalue'])
        df_cardiovascular['Dopamine'] = pd.to_numeric(df_cardiovascular['Dopamine'])
        df_cardiovascular['Epinephrine'] = pd.to_numeric(df_cardiovascular['Epinephrine'])
        df_cardiovascular['Norepinephrine'] = pd.to_numeric(df_cardiovascular['Norepinephrine'])
        df_cardiovascular['Dobutamine'] = pd.to_numeric(df_cardiovascular['Dobutamine'])
